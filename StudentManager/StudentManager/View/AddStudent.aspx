<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddStudent.aspx.cs" Inherits="StudentManager.View.AddStudent" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="../Styles/AddStudent.css" rel="stylesheet" />
    ...
    <table class="StuInfoTable">
        ...
        <tr>
            ...
            <td>
                 ...
                 <asp:Image ID="Image2" runat="server" ImageUrl="~/ThirdControls/CreateImage.aspx" />
